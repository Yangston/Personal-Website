  ...
  return (
    <LazyMotion features={domAnimation} strict>
      ...
      >
        ...
        <p className="relative z-10 max-w-xs text-center font-display text-4xl">
          Move through the signal field.
        </p>
        <m.div
          aria-hidden="true"
          style={{ x, y }}
          className="absolute left-1/2 top-1/2 size-28 -translate-x-1/2 -translate-y-1/2 rounded-full border-[18px] border-signal mix-blend-screen"
        />
      </div>
    </LazyMotion>
  );
