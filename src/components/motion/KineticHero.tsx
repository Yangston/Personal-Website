...
export default function KineticHero() {
  ...
  return (
    <LazyMotion features={domAnimation} strict>
      <section
        ref={ref}
        className="relative min-h-[calc(100svh-4.5rem)] overflow-hidden border-b border-ink/20 px-[var(--page-gutter)] py-12 md:min-h-[calc(100svh-5.5rem)] md:py-16"
      >
        <m.div
          style={{ y: driftDown }}
          aria-hidden="true"
          className="absolute -right-[8vw] top-[12%] size-[clamp(13rem,36vw,36rem)] rotate-12 rounded-full border-[clamp(1.5rem,5vw,5rem)] border-cobalt mix-blend-multiply"
        />
        <m.div
          style={{ y: driftUp }}
          aria-hidden="true"
          className="absolute bottom-[7%] left-[46%] h-[42%] w-[10%] -rotate-[28deg] bg-signal mix-blend-multiply"
        />
        <div className="relative z-10 flex min-h-[75svh] flex-col justify-between">
          ...
          <div>
            ...
            <div className="flex items-end justify-between gap-4 overflow-hidden pb-4">
              ...
              <span
                aria-hidden="true"
                className="mb-1 hidden text-5xl text-cobalt md:block"
              >
                ↘
              </span>
            </div>
          ...
          <div className="grid gap-8 border-t border-ink pt-5 md:grid-cols-2">
            <p className="max-w-xl text-lg font-medium leading-tight md:text-2xl">
