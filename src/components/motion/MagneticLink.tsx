...
export default function MagneticLink({ href, children, className = "" }: PropsWithChildren<{ href: string; className?: string }>) {
  ...
  return (
    <LazyMotion features={domAnimation} strict>
      <m.a href={href} onMouseMove={move} onMouseLeave={reset} style={{ x, y }} className={className}>{children}</m.a>
    </LazyMotion>
  );
}
